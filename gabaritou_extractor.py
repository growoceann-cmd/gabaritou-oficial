...
CONFIG = {
    ...
    "TARGET": "questoes", 
    "PAGINAS_PARA_EXTRAIR": 40, # Teste inicial de 40 páginas
    "HEADERS": {
...
async def run_gabaritou_engine():
    ...
    print(f"Iniciando Extracao Elite: {target.upper()}")
    ...
    async with httpx.AsyncClient(headers=CONFIG["HEADERS"], follow_redirects=True) as client:
        ...
        for i in range(1, pages + 1, batch_size):
            ...
            print(f"Progresso: {len(all_results)} itens extraidos...")
